...
# if [ $SIMcard != "ATT" ]; then
/data/local/tmp/scamperv6 -O text -p 1000 -c "trace -f 4 -q 1 -P udp" -i 2001:48d0:101:501:ec4:7aff:fe69:73e2 2>/dev/null > /data/local/tmp/Tmobile_sysnetv6_${index}/ship_$timestamp.txt
# fi
